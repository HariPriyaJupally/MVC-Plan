...
namespace MVC_Plan.Controllers
{
    public class DegreesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string searchString)
        {
            ...
            {
                degree = degree.Where(s => s.DegreeAbbrev.Contains(searchString));
            }

            switch (sortOrder)
            {
                case "degreeAbrrev_desc":
                    degree = degree.OrderByDescending(s => s.DegreeAbbrev);
                    break;
                case "DegreeName":
                ...
                case "degreeName_desc":
                    ...
                    break;
                default:
                    degree = degree.OrderBy(s => s.DegreeAbbrev);
                    break;
            }
        ...
        public async Task<IActionResult> Create([Bind("DegreeID,DegreeAbbrev,DegreeName,Done")] Degree degree)
        {
