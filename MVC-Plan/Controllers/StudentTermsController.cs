...
namespace MVC_Plan.Controllers
{
    public class StudentTermsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentTermId,StudentID,TermID,TermName")] StudentTerm studentTerm)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentTermId,StudentID,TermID,TermName")] StudentTerm studentTerm)
        {
