...
//This section is for Requirements
            ...
            else
            {
                var team_6 = new DegreePlanTermRequirement[]
                {
                    ...
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=1,TermID=1,RequirementID=460},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=2,TermID=1,RequirementID=542},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=3,TermID=1,RequirementID=563},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=4,TermID=2,RequirementID=560},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=5,TermID=2,RequirementID=555},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=6,TermID=2,RequirementID=618},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=7,TermID=3,RequirementID=1},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=8,TermID=3,RequirementID=664},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=9,TermID=3,RequirementID=10},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=10,TermID=4,RequirementID=20},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=11,TermID=4,RequirementID=691},
                    ...
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=14,TermID=1,RequirementID=542},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=15,TermID=1,RequirementID=563},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=16,TermID=2,RequirementID=560},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=17,TermID=2,RequirementID=555},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=18,TermID=2,RequirementID=618},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=19,TermID=4,RequirementID=1},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=20,TermID=4,RequirementID=664},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=21,TermID=4,RequirementID=10},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=22,TermID=5,RequirementID=20},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=23,TermID=5,RequirementID=691},
                    new DegreePlanTermRequirement{DegreePlanTermRequirementID=24,TermID=5,RequirementID=692},
